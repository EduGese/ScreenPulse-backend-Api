...
describe('FavoritesController', () => {
  ...
  describe('createFavorite', () => {
    it('should create a favorite and return 201 with data', async () => {
      ...
      await FavoritesController.createFavorite(
        req as Request,
        res as Response,
        next as NextFunction,
      );

      expect(favoritesService.createFavorite).toHaveBeenCalledWith(
  ...
  describe('deleteFavorite', () => {
    it('should delete favorite and send 200 with message', async () => {
      ...
      expect(favoritesService.deleteFavorite).toHaveBeenCalledWith(
        '507f191e810c19729de860ab',
        '507f191e810c19729de860ac',
      );
      expect(res.status).toHaveBeenCalledWith(200);
